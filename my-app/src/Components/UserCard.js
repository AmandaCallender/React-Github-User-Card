...
class userCard extends React.Component {
  ...
  getUserData = () => {
    fetch("https://api.github.com/users/AmandaCallender")
      // if successful
      .then((response) => {
  ...
  getUserFollowers = () => {
    fetch("https://api.github.com/users/AmandaCallender/followers")
      .then((response) => {
        return response.json();
      })
      .then((followers) => {
      ...
      <>
        ...
        <div className="app-user">
          ...
          <div className="followers">
            ...
            {Array.isArray(this.state.userFollowers) &&
