...
Now that you have completed the MVP, I want you to think about the process it took you to get here. Is there anything you wish you had planned better? Anything you would do differently? Now take a minute think about how you would accomplish these same objectives with function components and hooks. You have experience with both formats now, so you can form opinions, but more importantly, you can back up those opinions. That's a really exciting level to be at! If you have time now, go ahead and move onto the stretch problems.
      ...
      Each project has been different. This one I was able to look back at my old User Card and incorporate what I could, and change what needed to be changed to make this one work. I styled it differently but still maintained the same Usercard on the right with the followers on the left. Using function components would be similiar but I feel like I would have to go through each problem individually and figure out a solution. So much of what we do here is problem/solution based and I hesitate to even say that using one approach to a situation is better than any other because different problems will require different solutions. I won't pretend that I understand everything perfectly yet, I have only touched the surface of using these tools and I will not fully understand until I need to use it in a real life scenario. I will just try to do my best at completing these projects. Coding is super frustrating until it works.
